  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      ...
      {currentPage === 'library' ? (
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            ...
            <div className="text-center mb-16">
              <div className="relative inline-block mb-8">
                <div className="w-24 h-24 bg-gradient-to-br from-amber-600 via-orange-600 to-red-600 rounded-3xl flex items-center justify-center mx-auto shadow-2xl">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold bg-gradient-to-r from-amber-800 via-orange-800 to-red-800 bg-clip-text text-transparent mb-6">
                About Readpop
              </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-16">
              {/* Large Feature Card */}
              <div className="lg:col-span-2 bg-white rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 border border-orange-200 hover:shadow-2xl transition-all duration-300 group">
                <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform">
                    <Target className="w-8 h-8 text-white" />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-xl sm:text-2xl font-bold text-orange-900 mb-4">AI-Powered Discovery</h3>
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-amber-100 text-amber-700 rounded-full text-sm font-medium">Semantic Search</span>
                      <span className="px-3 py-1 bg-orange-100 text-orange-700 rounded-full text-sm font-medium">Machine Learning</span>
                      <span className="px-3 py-1 bg-red-100 text-red-700 rounded-full text-sm font-medium">Personalization</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Tall Feature Card */}
              <div className="lg:row-span-2 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 text-white hover:shadow-2xl transition-all duration-300 group">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-orange-100">Reading progress tracking</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-white rounded-full"></div>
                    <span className="text-orange-100">Personal notes & ratings</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-white rounded-full"></div>
                    <span className="text-orange-100">Smart recommendations</span>
                  </div>
                </div>
              </div>
              
              {/* Community Features */}
              <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 border border-orange-200 hover:shadow-2xl transition-all duration-300 group">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-orange-900 mb-3">Community Insights</h3>
              ...
              <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 border border-orange-200 hover:shadow-2xl transition-all duration-300 group">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-orange-900 mb-3">Trending & Popular</h3>
                <p className="text-orange-700 leading-relaxed">
            ...
            {/* Stats Section */}
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 border border-orange-200 mb-16">
              <div className="text-center mb-8">
                <h3 className="text-xl sm:text-2xl font-bold text-orange-900 mb-2">Powered by Advanced Technology</h3>
                <p className="text-orange-700">Our platform combines cutting-edge AI with comprehensive book data</p>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
                <div className="text-center">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-orange-900">1M+</div>
                  <div className="text-orange-700 text-sm">Books in Database</div>
                </div>
                <div className="text-center">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-orange-900">AI-Powered</div>
                  <div className="text-orange-700 text-sm">Semantic Search</div>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl flex items-center justify-center mx-auto mb-3">
                    <Star className="w-6 h-6 text-white" />
                  </div>
                  <div className="text-xl sm:text-2xl font-bold text-orange-900">Personalized</div>
                  <div className="text-orange-700 text-sm">Recommendations</div>
                </div>
                <div className="text-center">
                  ...
                  <div className="text-xl sm:text-2xl font-bold text-orange-900">Real-time</div>
                  <div className="text-orange-700 text-sm">Updates</div>
                </div>
              </div>
            </div>
            
            {/* CTA Section */}
            <div className="bg-gradient-to-r from-amber-600 via-orange-600 to-red-700 rounded-2xl sm:rounded-3xl shadow-2xl p-8 sm:p-12 text-center text-white">
              <h3 className="text-2xl sm:text-3xl font-bold mb-4">Ready to Discover Your Next Favorite Book?</h3>
              <p className="text-orange-100 max-w-2xl mx-auto mb-8 text-base sm:text-lg">
                Join thousands of readers who have found their perfect books through our AI-powered recommendations.
              </p>
              <button className="bg-white text-orange-600 px-6 sm:px-8 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg hover:bg-gray-100 transition-colors shadow-lg hover:shadow-xl">
        ...
        <div className="mb-8">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-4 sm:p-6 border border-orange-200">
        ...
        <div className="mb-8">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 border border-orange-200">
            <div className="text-center mb-8">
              <div className="inline-flex items-center space-x-3 mb-4">
                ...
                <h2 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-amber-800 via-orange-800 to-red-800 bg-clip-text text-transparent">
                  Discover your next great read
                </h2>
              </div>
              <p className="text-base sm:text-lg text-orange-700 max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          {isLoading && (
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-8 sm:p-12 border border-orange-200">
              <LoadingSpinner 
          ...
          {error && (
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 border border-red-200">
          ...
          {!isLoading && !error && hasSearched && results.length > 0 && (
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl p-6 sm:p-8 border border-orange-200">
              <div className="flex items-center justify-between mb-8">
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold text-orange-900 flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <span className="text-lg font-semibold text-orange-900">Readpop</span>
            </div>
